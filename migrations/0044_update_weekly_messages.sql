-- Migration: Update weekly email messages with new VC-focused content
-- Los mensajes ahora están estructurados para trackear métricas como un VC
...
Responde a este email con tus respuestas.',
    category = 'ideas',
    expects_response = 1,
...
Responde a este email con tu Weekly Summary.',
    category = 'reflect',
    expects_response = 1,
