-- Migration: LinkedIn Connections Tracking
-- Adds table for tracking LinkedIn connections and outreach campaigns
...
CREATE TABLE IF NOT EXISTS linkedin_connections (
  ...
  status TEXT DEFAULT 'pending' CHECK (status IN ('pending', 'contacted', 'responded', 'meeting_scheduled', 'connected', 'declined')),
  notes TEXT,
