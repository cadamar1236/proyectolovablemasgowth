          ...
          <div class="flex h-screen bg-gray-50">
            ...
            <div class="w-64 bg-white shadow-lg flex flex-col">
              ...
              <nav class="flex-1 px-3 overflow-y-auto">
                <a href="/dashboard" class="flex items-center px-4 py-3 text-gray-700 bg-primary/10 rounded-lg mb-2">
                  <i class="fas fa-home mr-3"></i>
                  Home (HQ)
                </a>
                <a href="#notifications" class="flex items-center px-4 py-3 text-gray-600 hover:bg-gray-100 rounded-lg mb-2">
                  <i class="fas fa-bell mr-3"></i>
                  Notifications
                </a>
                <a href="#traction" class="flex items-center px-4 py-3 text-gray-600 hover:bg-gray-100 rounded-lg mb-2">
