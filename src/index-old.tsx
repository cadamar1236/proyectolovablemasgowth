...
<body class="bg-gray-50 min-h-screen">
    <!-- Navigation -->
    <nav class="bg-white sticky top-0 z-50 border-b border-gray-200 nav-shadow">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:flex flex-1 max-w-md mx-8">
                    <div class="relative w-full">
                        <input type="text" 
                               ...
                               class="w-full px-4 py-2 pl-10 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent"
                               id="search-input">
                ...
                <div class="flex items-center space-x-1">
                    <a href="/" class="hidden md:flex items-center px-4 py-2 text-sm font-medium text-gray-700 hover:text-primary rounded-lg hover:bg-gray-50 transition">
                        <i class="fas fa-info-circle mr-2"></i>How it works
                    </a>
                    <a href="/marketplace" class="flex items-center px-4 py-2 text-sm font-medium text-primary bg-blue-50 rounded-lg hover:bg-blue-100 transition">
                        <i class="fas fa-store mr-2"></i>Marketplace
                    </a>
                    <a href="/leaderboard" class="hidden sm:flex items-center px-4 py-2 text-sm font-medium text-gray-700 hover:text-primary rounded-lg hover:bg-gray-50 transition">
                        <i class="fas fa-trophy mr-2"></i>Leaderboard
                    </a>
                    <button onclick="showAuthModal('login')" class="px-4 py-2 text-sm font-medium text-gray-700 hover:text-primary rounded-lg hover:bg-gray-50 transition">
                        Log In
                    </button>
                    <button onclick="showAuthModal('register')" class="px-4 py-2 text-sm font-medium text-white bg-primary hover:bg-blue-700 rounded-lg transition">
                        Sign Up
                    </button>
                </div>
            </div>
    ...
    <div class="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center space-x-2 mb-6 overflow-x-auto pb-2">
            <button class="px-4 py-2 text-sm font-medium bg-white text-primary border-2 border-primary rounded-lg whitespace-nowrap">
                All
            </button>
            <button class="px-4 py-2 text-sm font-medium bg-white text-gray-700 border border-gray-300 rounded-lg hover:border-gray-400 whitespace-nowrap">
                Trending
            </button>
            <button class="px-4 py-2 text-sm font-medium bg-white text-gray-700 border border-gray-300 rounded-lg hover:border-gray-400 whitespace-nowrap">
                Most Liked
        ...
        <div class="bg-white border border-gray-200 rounded-xl p-8 text-center mb-8">
            ...
            <button onclick="showUploadProductForm()" class="px-6 py-3 bg-primary text-white rounded-lg font-medium hover:bg-blue-700 transition">
    ...
    <div id="auth-modal" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <!-- Modal content will be loaded from marketplace.js -->
    </div>
                    ...
                    <div class="card-product p-5 cursor-pointer" onclick="window.location.href='/marketplace?product=\${product.id}'">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <button onclick="event.stopPropagation(); likeProduct(\${product.id})" 
                                    class="btn-like px-4 py-2 rounded-lg font-medium text-sm \${product.user_vote ? 'btn-liked' : 'btn-unliked'}">
